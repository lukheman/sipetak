            ...
            <div class="card-body">
                <div class="d-flex justify-content-center align-items-center flex-column">
                    <div class="avatar avatar-2xl">
                        <img class="img-md rounded-circle" src="{{ $form->photo
    ? (is_string($form->photo)
        ? asset('storage/' . $form->photo)
        : $form->photo->temporaryUrl())
    : asset('images/default-avatar.png') }}" alt="Foto Profil" width="150" height="150">
                    </div>
                    <div class="mt-2">
                        ...
                        <div class="row">
                            ...
                            <div class="col-6">
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <input wire:model="kecamatanUser" type="text" id="kecamatan" class="form-control"
                                        disabled>
                                </div>
                            </div>
